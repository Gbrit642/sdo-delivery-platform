...
| [**`03_post_implementation_and_operations/org_policy_and_iap_guide.md`**](./03_post_implementation_and_operations/org_policy_and_iap_guide.md) | Ingress setup complying with `constraints/run.managed.requireInvokerIam`. | IAP Load Balancer, Serverless NEGs, local IAM proxy. |
